...
- **Price rows:** двухчастная акриловая plate: чёрная зона с жёлтым названием переходит через диагональный золотой bevel в жёлтую грань с чёрной ценой; снаружи остаётся замкнутая двойная золотая рамка варианта SIGMA.
