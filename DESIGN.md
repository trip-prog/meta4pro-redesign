...
- **Price rows:** глубокая дымчато-чёрная акриловая plate с замкнутой двойной золотой рамкой, многослойными кристальными фасками и крупным жёлтым Oswald-числом.
