...
- **Touch motion:** горизонтальные rails листаются нативным свайпом; тяжёлые 3D-слои и раскрытие зон на touch не анимируются, чтобы не просаживать слабые телефоны.
...
- **Navigation:** на mobile пять компактных плашек закреплены снизу с учётом safe area, текущий раздел подсвечен жёлтым; с 720px появляется открытая горизонтальная навигация с телефоном, а с 1100px rail становится правым desktop-элементом.
